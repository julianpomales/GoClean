    ...
    <div className="min-h-screen bg-grain flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10">
        ...
        >
          ...
          {/* Subtitle */}
          <p className="font-mono text-sm sm:text-base text-slate-400 leading-relaxed mb-16 max-w-xl text-center uppercase tracking-wide">
          ...
          <div className="flex flex-col items-center gap-6 w-full mt-8">
            <button
              onClick={handleGoogleSignIn}
              disabled={loading}
              className="group relative flex items-center gap-4 bg-white text-black px-8 py-4 font-display font-bold text-sm uppercase tracking-widest transition-all duration-200 hover:bg-neon-green hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_0_1px_rgba(255,255,255,0.15)] hover:shadow-[0_0_30px_rgba(57,255,20,0.25)]"
            >
            ...
            <span className="font-mono text-[10px] uppercase tracking-widest text-slate-600">— OR USE THE NAV LINK ABOVE —</span>
